...
ACLOCAL = ${SHELL} /home/pi/mednafen/missing --run aclocal-1.11
ALLOCA = 
ALSA_CFLAGS = 
ALSA_LIBS =  -lasound -lm -ldl -lpthread
AMTAR = $${TAR-tar}
AM_CFLAGS =  -fsigned-char  -Wall -Winline -Wshadow -Wempty-body -Wignored-qualifiers  -fno-fast-math -fno-unsafe-math-optimizations -fomit-frame-pointer -finline-limit=6000 --param large-function-growth=800 --param inline-unit-growth=175 --param max-inline-insns-single=10000 -fno-strict-overflow
AM_CXXFLAGS =  -fsigned-char  -Wall -Winline -Wshadow -Wempty-body -Wignored-qualifiers  -fno-fast-math -fno-unsafe-math-optimizations -fomit-frame-pointer -finline-limit=6000 --param large-function-growth=800 --param inline-unit-growth=175 --param max-inline-insns-single=10000 -fno-strict-overflow
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/pi/mednafen/missing --run autoconf
AUTOHEADER = ${SHELL} /home/pi/mednafen/missing --run autoheader
AUTOMAKE = ${SHELL} /home/pi/mednafen/missing --run automake-1.11
AWK = mawk
...
CCASFLAGS = -mtune=arm1176jzf-s
CCDEPMODE = depmode=gcc3
CFLAGS = -mtune=arm1176jzf-s
CFLAG_VISIBILITY = -fvisibility=hidden
CPP = gcc -E
CPPFLAGS =     -mtune=arm1176jzf-s 
CXX = g++
CXXCPP = g++ -E
...
LIBPTH = 
LIBPTH_PREFIX = 
LIBS = -lsndfile   -lcdio -lm   -lz -lrt  -lz  -lasound -lm -ldl -lpthread
LIBTHREAD = 
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /home/pi/mednafen/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MMX_CFLAGS = 
MSGFMT = :
...
abs_builddir = /home/pi/mednafen
abs_srcdir = /home/pi/mednafen
abs_top_builddir = /home/pi/mednafen
abs_top_srcdir = /home/pi/mednafen
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/pi/mednafen/install-sh
